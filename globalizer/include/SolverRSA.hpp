#ifndef __SOLVER_RSA_H__
#define __SOLVER_RSA_H__
...
class Solver_RSA : public ISolver
{
protected:
	...
	*/
	...
	/// Решатель производящий вычисление при параллельном АПН (распараллеливание по точкам) на MPI
	void MpiCalculation();
...
public:
	Solver_RSA(IProblem* problem);

#ifdef _GLOBALIZER_BENCHMARKS

	Solver_RSA(IGlobalOptimizationProblem* problem);
